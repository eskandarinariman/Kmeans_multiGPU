...
/* kmeans functions */
int device_setup_data(float **h_data, float **d_data, float **d_clusters,
...
int run_kmeans(const float *h_data, const float *d_data, float *h_clusters, float *d_clusters,
